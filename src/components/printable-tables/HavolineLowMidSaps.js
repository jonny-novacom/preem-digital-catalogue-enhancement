...
const ComponentToPrint = forwardRef((props, ref) => {
  ...
  return (
    <div className="overflow-x-scroll">
      <div ref={ref}>
        <h3 className="hidden w-[218%] mt-12 mb-8 text-5xl font-bold text-center text-preemGreen font-gothamNarrow printable">
          Översikt motoroljespecifikationer/prestanda för personbilar och lätta
          transportfordon
        </h3>
        <h4 className="hidden w-[218%] mt-12 mb-24 text-5xl font-bold text-center text-preemGreen font-gothamNarrow printable">
          Low & Mid SAPS
        </h4>
...
export default function HavolineLowMidSaps() {
  const ref = useRef();
